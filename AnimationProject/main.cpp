...
static void drawLine(Mesh& line, glm::vec3 from, glm::vec3 to)
{
...
public:
    ...
    Scene(MainWindow& window) : window(window)
    {
...
public:
    CubeDropScene(MainWindow& window): Scene(window)
    {
    ...
    void start() override
    {
        ...
        collider = CubeCollider(glm::vec3(1.5f,0.5f,0.5f));
...
{
public:
    MainApplication(int argc, char *argv[]): QGuiApplication(argc, argv)
    {
